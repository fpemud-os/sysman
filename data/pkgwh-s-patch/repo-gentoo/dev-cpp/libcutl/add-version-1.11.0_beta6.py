...
if len(glob.glob("libcutl-1.11.*.ebuild")) == 0:
    with open("libcutl-1.11.0_beta6.ebuild", "w") as f:
        f.write("""
...
""")
    subprocess.run(["ebuild", "libcutl-1.11.0_beta6.ebuild", "manifest"], stdout=subprocess.DEVNULL)
else:
    print("outdated")
